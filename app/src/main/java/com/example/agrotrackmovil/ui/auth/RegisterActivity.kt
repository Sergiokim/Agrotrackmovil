...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set spannable text for login link
        ...
        registerButton.setOnClickListener {
            ...
            db.collection("users")
                ...
                .addOnSuccessListener { documents ->
                    ...
                    // Guardar en Firestore con ID generado automáticamente
                    db.collection("users")
                        .add(user)
                        .addOnSuccessListener { documentReference ->
                            val userId = documentReference.id // Obtener el ID generado
                            // Guardar userId en SharedPreferences para la sesión
